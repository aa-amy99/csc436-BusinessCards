(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusinessCardComponent = /** @class */ (function () {
                function BusinessCardComponent(businessCardsService) {
                ...
                BusinessCardComponent.prototype.openEditForm = function (card) {
                    this.tmpID = card.id;
                    console.log(card.id);
                };
                BusinessCardComponent.prototype.closeEditForm = function () {
                    this.tmpID = '';
                };
                BusinessCardComponent.prototype.update = function (card) {
                ...
                BusinessCardComponent.prototype.delete = function (card) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusinessCardsComponent = /** @class */ (function () {
                ...
                BusinessCardsComponent.prototype.getBusinessCards = function () {
                    var _this = this;
                    this.businessCardsService.getMyCardsContainers().snapshotChanges()
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])(function (changes) { return changes.map(function (c) { return (Object.assign({ id: c.payload.doc.id }, c.payload.doc.data())); }); })).subscribe(function (card) {
                        _this.businessCards = card;
                    });
                };
                BusinessCardsComponent.prototype.onClikcAdd = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BusinesscardsService = /** @class */ (function () {
                ...
                BusinesscardsService.prototype.removeMyCard = function (cardID) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WebcamService = /** @class */ (function () {
                ...
                WebcamService.prototype.getData = function (imageBase64) {
                    var parsedImage = imageBase64.replace(/^data:image\/(png|jpg|jpeg);base64,/, '');
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WebCamComponent = /** @class */ (function () {
                ...
                WebCamComponent.prototype.receiveWebcamImage = function (imageBase64) {
                    this.businessCard.image = imageBase64;
                };
                WebCamComponent.prototype.receiveTextDetection = function (textDetection) {
                    console.log(textDetection.responses[0].textAnnotations);
                };
                WebCamComponent.prototype.triggerSnapshot = function () {
                    this.trigger.next();
                };
                ...
                WebCamComponent.prototype.convertToBase64 = function () {
                    var _this = this;
                    ...
                    dom_to_image__WEBPACK_IMPORTED_MODULE_4___default.a.toPng(imgNode)
                        ...
                        _this.imageBase64.emit(dataUrl);
                        _this.webcamService.getData(dataUrl)
                            .subscribe(function (res) {
                            _this.textDetection.emit(res);
                        }, function (err) {
                            console.log(err);
                        });
                    }).catch(function (e) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var WebcampageComponent = /** @class */ (function () {
                ...
                WebcampageComponent.prototype.toggleWebcam = function () {
                    this.onWebcam = !this.onWebcam;
                    this.businessCard = new _models_businesscard_model__WEBPACK_IMPORTED_MODULE_2__["Businesscard"]();
                };
                WebcampageComponent.prototype.receiveWebcamImage = function (imageBase64) {
                    this.businessCard.image = imageBase64;
                };
                WebcampageComponent.prototype.receiveTextDetection = function (textDetection) {
                    console.log(textDetection.responses[0].textAnnotations);
                };
